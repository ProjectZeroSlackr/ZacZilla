...
TWindow *new_invaders2_window()
{
	...
	/* load graphics */
	aliens_gfx  = ttk_load_image ("/mnt/aj/invaders2/alien.png");
	player_gfx = ttk_load_image ("/mnt/aj/invaders2/player.png");
	die_gfx[0] = ttk_load_image ("/mnt/aj/invaders2/die0.png");
	die_gfx[1] = ttk_load_image ("/mnt/aj/invaders2/die1.png");
	die_gfx[2] = ttk_load_image ("/mnt/aj/invaders2/die2.png");
	die_gfx[3] = ttk_load_image ("/mnt/aj/invaders2/die3.png");
