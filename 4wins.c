...
void set_fonts(ttk_surface srf)
{
	...
	{
		image_stone[0]=ttk_load_image("/mnt/aj/0s.png");
	  if (!(image_stone[1]=ttk_load_image("/mnt/aj/1s.png")))
	  {
		  error_message(srf, "Load failed");
		}
	  image_stone[2]=ttk_load_image("/mnt/aj/2s.png");
	  image_pfeil=ttk_load_image("/mnt/aj/pfeil_s.png");
	  image_turn[1]=ttk_load_image("/mnt/aj/turn_1.png");
	  image_turn[2]=ttk_load_image("/mnt/aj/turn_2.png");
	}
	  
	else if(ttk_screen->w == 138)
	{
		image_stone[0]=ttk_load_image("/mnt/aj/0m.png");
	  if (!(image_stone[1]=ttk_load_image("/mnt/aj/1m.png")))
	  {
		  error_message(srf, "Load failed");
		}
	  image_stone[2]=ttk_load_image("/mnt/aj/2m.png");
	  image_pfeil=ttk_load_image("/mnt/aj/pfeil_m.png");
	  image_turn[1]=ttk_load_image("/mnt/aj/turn_1.png");
	  image_turn[2]=ttk_load_image("/mnt/aj/turn_2.png");
	}
	...
	{
		image_stone[0]=ttk_load_image("/mnt/aj/0.png");
	  if (!(image_stone[1]=ttk_load_image("/mnt/aj/1.png")))
	  {
		  error_message(srf, "Load failed");
		}
	  image_stone[2]=ttk_load_image("/mnt/aj/2.png");
	  image_pfeil=ttk_load_image("/mnt/aj/pfeil.png");
	  image_turn[1]=ttk_load_image("/mnt/aj/turn_1.png");
	  image_turn[2]=ttk_load_image("/mnt/aj/turn_2.png");
	}
}
