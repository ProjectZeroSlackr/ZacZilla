...
static int load_level (int lev)
{
	 ...
	 snprintf(filename, sizeof(filename), "/mnt/aj/levels/%d.lev", lev);
...
static int save_score()
{
	 ...
	 file = fopen("/mnt/aj/brickscore.conf", "w");
	 if(file == NULL) {
...
static int load_score()
{
	 ...
	 file = fopen("/mnt/aj/brickscore.conf", "a+");
	 if(file == NULL) {
...
static void brickm_start()
{
	 ...
	 if(ttk_screen->w >= 220) {
	    ...
	    brickmania_powerups = ttk_load_image("/mnt/aj/images/brickmania_powerups.gif");
	    brickmania_ball = ttk_load_image("/mnt/aj/images/brickmania_ball.gif");
	    brickmania_break = ttk_load_image("/mnt/aj/images/brickmania_break.gif");
	    brickmania_bricks = ttk_load_image("/mnt/aj/images/brickmania_bricks.gif");
	    brickmania_gameover = ttk_load_image("/mnt/aj/images/brickmania_gameover.gif");
	    brickmania_menu_bg = ttk_load_image("/mnt/aj/images/brickmania_menu_bg.gif");
	    brickmania_menu_items = ttk_load_image("/mnt/aj/images/brickmania_menu_items.gif");
	    brickmania_pads = ttk_load_image("/mnt/aj/images/brickmania_pads.gif");
	 }
	 else {
	    ...
	    brickm_srf = ttk_new_surface (LCD_WIDTH, LCD_HEIGHT, ttk_screen->bpp);
	    brickmania_powerups = ttk_load_image("/mnt/aj/images/brickmania_powerups1.gif");
	    brickmania_ball = ttk_load_image("/mnt/aj/images/brickmania_ball.gif");
	    brickmania_break = ttk_load_image("/mnt/aj/images/brickmania_break1.gif");
	    brickmania_bricks = ttk_load_image("/mnt/aj/images/brickmania_bricks1.gif");
	    brickmania_gameover = ttk_load_image("/mnt/aj/images/brickmania_gameover1.gif");
	    brickmania_menu_bg = ttk_load_image("/mnt/aj/images/brickmania_menu_bg1.gif");
	    brickmania_menu_items = ttk_load_image("/mnt/aj/images/brickmania_menu_items1.gif");
	    brickmania_pads = ttk_load_image("/mnt/aj/images/brickmania_pads1.gif");
	 }
