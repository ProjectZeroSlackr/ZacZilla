...
static int event_duckhunt_highscore (TWidget *this,int button) 
{
    ...
    if (button == TTK_BUTTON_NEXT) { writeHighScore("/mnt/aj/duckhunt/hs",0); this->dirty = 1;}
    return 0;
}
...
static int down_duckhunt(TWidget *this,int button)
{
      ...
      case TTK_BUTTON_HOLD:
      	 if ( score > readHighScore("/mnt/aj/duckhunt/hs") )
      	  writeHighScore("/mnt/aj/duckhunt/hs",score); 
